...
var options = ["advantage", "disadvantage"],
    j = 0; //Choose Advantage as default

var form = d3.select("#vis");
...
function draw(value) {
    ...
    d3.csv("calls/" + value + ".csv", function(error, csv_data) {
      ...
      function draw_line(valueLine) {
        console.log(csv_data[0][valueLine]);
      ...
      function mouseOver(d,i) {
          ...
          tooltip
              .style('display', null)
              .html('<p>Number of calls in ' + valueLine + " " + d[valueLine] + '<br>Seconds left: ' + (+d.seconds_left+5) +'</p>');
      };
      ...
      d3.selectAll("input").on("change", function() {
        ...
        valueLine = this.value;
        console.log(valueLine);
        draw_line(valueLine);
      });
      draw_line("disadvantage");
